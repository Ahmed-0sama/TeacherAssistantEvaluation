        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GSDean_Evaluations_EvaluationID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessorCourseEvaluations_EvaluationID",
                        column: x => x.EvaluationID,
                        principalSchema: "taEvaluation",
                        principalTable: "Evaluations",
                        principalColumn: "EvaluationID");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VPGS_Evaluations_EvaluationID",
                        column: x => x.EvaluationID,
                        principalSchema: "taEvaluation",
                        principalTable: "Evaluations",
                        principalColumn: "EvaluationID");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__GSDean_E__36AE68D2CAE39685",
                schema: "taEvaluation",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessorCourseEvaluations_EvaluationID",
                schema: "taEvaluation",
